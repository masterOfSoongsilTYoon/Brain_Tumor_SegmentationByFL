...
def evaluate_fn(roundn, parameters, config):
    ...
    test_loader = torch.utils.data.DataLoader(test_data, batch_size=4, shuffle=False, num_workers=0, collate_fn = lambda x: x)
...
if __name__ == "__main__":
    ...
    save_csv(csv_history, mode="train", name="Brain_FL_Avg")